...
const { handleRegister } = require("./registration");
...
async function handleGuidelines(interaction) {
    const guidelinesMessage = new EmbedBuilder()
        ...
        .setDescription('Please follow these guidelines to ensure a positive experience:')
        .addFields(
            { 
            ...
            { 
                ...
                value: 'Avoid misuse of commands to ensure smooth operation for everyone.' 
            },
            { 
                name: '3.Provide Constructive Feedback', 
                value: 'Feedback should be constructive, relevant, and aimed at improving the bot.' 
            },
            { 
                name: '4.Ask Questions', 
                value: 'If you have questions, ask in the designated channels or use `/help`.' 
            },
            { 
                name: '5.Report Issues', 
                value: 'Report any issues with `/feedback` to help us maintain a great experience.' 
            }
        )
        .setFooter({ text: 'Thank you for helping us maintain a positive community.' });
