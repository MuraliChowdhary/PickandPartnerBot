...
async function handleFeedback(interaction) {
  const feedbackMessage = new EmbedBuilder()
    ...
    .setTitle("Feedback")
    .setDescription(
      "We appreciate your feedback! Please provide details about any issues or suggestions below."
    )
    .addFields(
      {
        name: "1️⃣ Reporting Issues",
        value:
          "If you’re facing a problem with a command, please describe it here. This helps us troubleshoot effectively.",
      },
      {
        name: "2️⃣ Suggestions",
        value:
          "Have ideas for new features or improvements? Let us know how we can make the bot better for you!",
      },
      {
        name: "How to Submit:",
        value:
          "Use `/submitFeedback <your message>` to send us your thoughts or any issues you’re facing.",
      }
    )
